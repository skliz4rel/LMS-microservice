...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.a2x.chinaka.excercise"))
                .build();
    }
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                ...
                .description("This micro service helps with intercommunication between Scoring service and CBS")
                .version("1.0.0")
                .build();
    }
